  ...
  return (
    <div className="min-h-screen bg-[#07070E] px-4 py-6 max-w-lg mx-auto">
      ...
      <a
        ...
        className="flex items-center gap-2 w-full mt-6 rounded-xl px-3 py-2.5 transition-all"
      ...
      >
        ...
        <div>
          <p className="text-white font-bold text-xs">¿Necesitas ayuda?</p>
          <p className="text-white/80 text-[10px]">Soporte directo con BBX</p>
        </div>
      </a>
