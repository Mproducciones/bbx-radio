  ...
  return (
    <div className="min-h-screen bg-[#07070E] px-4 py-6 max-w-lg mx-auto">
      ...
      <a
        ...
        className="flex items-center gap-3 w-full mt-6 rounded-xl px-5 py-4 transition-all hover:opacity-90"
        style={{ background: '#128C7E', boxShadow: '0 4px 24px 0 rgba(18,140,126,0.25)' }}
      >
        ...
        <span>
          ...
          <span className="block text-lg font-bold text-white">Soporte directo con BBX</span>
        </span>
      </a>

      <div className="mt-6 text-center text-[#444468] text-xs pb-4">
        Powered by BBX
      </div>
    </div>
  )
