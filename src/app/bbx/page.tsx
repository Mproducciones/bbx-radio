...
const PLANES = [
  {
    ...
    noIncluye: ['Noticias y eventos', 'Replay de programas', 'Página de publicidad', 'Panel de administración', 'APK nativa Android'],
  },
  {
    nombre: 'Pro',
    precio: '80.000',
    ...
    incluye: [
      ...
      'Noticias y eventos (CMS incluido)',
      'Replay de programas grabados',
      'Página de publicidad con paquetes para anunciantes',
