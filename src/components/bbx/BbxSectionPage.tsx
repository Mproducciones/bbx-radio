...
export function BbxSectionPage({
  ...
  return (
    <motion.div
      className="relative flex flex-col w-full min-w-0 text-white overflow-x-hidden min-h-full mesh-bg"
    ...
    >
      ...
      >
        <div className="app-gutter-x w-full md:max-w-6xl md:mx-auto md:px-4 min-h-12 py-2 flex items-center gap-2">
          <button
            type="button"
            onClick={onBack}
      ...
      <div className="app-gutter-x relative z-[1] flex-1 min-w-0 w-full md:max-w-6xl md:mx-auto md:px-4 py-5 pb-[max(1.5rem,env(safe-area-inset-bottom,0px))]">
