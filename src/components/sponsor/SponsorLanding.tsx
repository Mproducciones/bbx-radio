...
function WhatsAppButton({ phone }: { phone: string }) {
  ...
  return (
    <a
      ...
      className="group relative inline-flex items-center gap-3 bg-gradient-to-r from-[#25D366] to-[#128C7E] text-white px-8 py-4 rounded-xl font-semibold text-base shadow-lg shadow-[#25D366]/25 hover:shadow-[#25D366]/40 transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0"
    >
      ...
      <span className="relative">
        <span className="block text-sm font-medium opacity-90">Contáctanos por</span>
        <span className="block text-lg font-bold">WhatsApp</span>
      </span>
      {/* Efecto hover shine */}
      <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-transparent via-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 -translate-x-full group-hover:translate-x-full" style={{ transition: 'opacity 0.3s, transform 0.6s' }} />
    </a>
  )
}
