...
export function SponsorValueSection() {
  ...
  return (
    <section className="mb-10">
      <h2 className="font-display text-2xl md:text-3xl text-white mb-2">{SPONSOR_VALUE.title}</h2>
      <p className="text-white/45 text-sm mb-5 leading-relaxed">{SPONSOR_VALUE.intro}</p>
